...
1. Review APP-013 urgency/payment-exception Calendar policy guards on backend `codex/app-013-transactional-messaging` (PR #21), including both reservation/policy race orders, competing snapshot and audit rollback proof, and desktop/390px conflict handling. Owner approved remaining-risk item 1; APP-012 and BE-008 remain accepted.
...
## Latest APP-013 Policy-Update Calendar Guards (2026-09-08)
