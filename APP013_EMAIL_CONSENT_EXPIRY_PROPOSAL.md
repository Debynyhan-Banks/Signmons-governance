...
Split customer/operator request submission and private read are locally review-ready, without storing or reconstructing a customer bearer. They do not mutate or bind consent or create a job. Original expiry applies; operator decision/admission is next proposed as an atomic request/job/consent outcome with no external actions. Mailbox verification, expiry/delivery admission, retention, production transport and delivery remain unfinished.
