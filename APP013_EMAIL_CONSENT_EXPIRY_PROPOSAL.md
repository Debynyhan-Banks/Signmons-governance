...
Integrated protected intake is locally review-ready: optional grant/decline/no-email branches reach a read-only validated draft, while historical email choice never authorizes sending. Capture/respond each remain separately durable with exact retry; skip creates no evidence. Next proposed: local atomic intake-to-job handoff and session/job/consent binding with human review, no Calendar/payment/provider activation. Mailbox verification, expiry/admission, retention and delivery remain unfinished.
