...
Status: R06 qualification complete and review-ready; NOT executable and NOT R07 authorization. Owner approved restricted-runtime-role preparation after backend838468c/governance95fbea2. APP013_P06_RUNTIME_ROLE_REVIEW.md now supplies the exact grant manifest, actual limited-login local/browser proof, native private password/secret-entry procedure and expiry/session-termination boundary. The earlier identity decision below is resolved for preparation, not live creation. Owner approved regular-only initial diagnosis with one USD99 deposit; full USD150 after-hours replacement remains documented, not implemented. No emergency case, real charge, booking, dispatch or confirmation send.
