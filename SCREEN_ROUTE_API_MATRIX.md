...
| `SCR-APP-021`, `SCR-APP-022`, `SCR-TECH-005` | ticket-defined; UI routes not implemented | backend app surface | operator `POST /communications/sms/transactional`, `GET /communications/sms/history`; existing technician status API triggers customer on-the-way SMS; technician-recipient notifications remain planned | APP-013 Transactional SMS Lifecycle Contract | APP-013 | queue/history, appointment and on-the-way triggers in review; remaining events and UI planned |
