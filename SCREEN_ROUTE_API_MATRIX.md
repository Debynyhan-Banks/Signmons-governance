...
| `SCR-APP-021` | `/app/notifications` | backend app surface | `GET /communications/sms/history` | APP-013 Transactional SMS Lifecycle Contract | APP-013 | read-only SMS history in review; fixture browser QA; live acceptance pending |
