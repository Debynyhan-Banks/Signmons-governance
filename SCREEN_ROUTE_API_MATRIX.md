...
| `SCR-APP-022`, `SCR-TECH-005` | ticket-defined; UI routes not implemented | backend app surface | operator `POST /communications/sms/transactional`; existing technician status API triggers customer on-the-way SMS; technician-recipient notifications remain planned | APP-013 Transactional SMS Lifecycle Contract | APP-013 | queue and lifecycle triggers in review; template controls and technician notification UI planned |
