...
| `SCR-TECH-005` | ticket-defined; UI route not implemented | backend app surface | existing technician status API triggers customer on-the-way SMS; technician-recipient notifications remain planned | APP-013 Transactional SMS Lifecycle Contract | APP-013 | technician notification inbox proposed, not implemented or approved to start |
