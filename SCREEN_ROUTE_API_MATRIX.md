...
| `SCR-APP-021` | `/app/notifications` | backend app surface | `GET /communications/sms/history`; `GET /communications/sms/enqueue-intents` | APP-013 Transactional SMS Lifecycle Contract | APP-013 | read-only SMS history and initial-confirmation/technician intent visibility in review; recovery actions/live acceptance pending |
