...
| `SCR-APP-018`, `SCR-APP-019` | `/app/revenue`, `/app/conversion` (planned) | backend app surface | `GET /reports/lead-sources` pilot; broader revenue/funnel APIs remain APP-014 | tenant lead-source report contract | BE-007 pilot + APP-014 | pilot backend in progress |
