...
| `SCR-APP-021` | `/app/notifications` | backend app surface | `GET /communications/sms/history`; `GET /communications/sms/enqueue-intents`; `GET /communications/sms/capabilities`; owner/admin `POST /communications/sms/enqueue-intents/:intentId/retry` | APP-013 Transactional SMS Lifecycle Contract | APP-013 | guarded exhausted-intent retry UI in review; owner/live acceptance pending |
