...
| `SCR-APP-021`, `SCR-APP-022`, `SCR-TECH-005` | ticket-defined; UI routes not implemented | backend app surface | operator `POST /communications/sms/transactional`, `GET /communications/sms/history`; technician notifications remain planned | APP-013 Transactional SMS Queue Contract | APP-013 | operator queue/history and state checks in review; UI and lifecycle integration planned |
