...
- [ ] 2. Default-disabled startup/asset wiring. Main currently calls both middleware factories without bindings.
...
Three concrete tasks remain. No new acceptance section/package; P06 and walkthrough acceptance unchanged. The older references to three broad P06 items are historical, not the owner-facing task count.
