...
| Backend | `APP-013` appointment and technician-on-the-way triggers, canonical event identity and send-time stale-message rejection are review-ready on PR #21; durable enqueue recovery and remaining events/UI/email stay open; BE-008 accepted | active |
