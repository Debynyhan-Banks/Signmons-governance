...
- Program `Now`: `FE-011` (brand voice and AI personality page)
...
| --- | --- | --- |
| Governance | FE-010 merged and pointer advanced to FE-011 | done |
| Frontend marketing | `FE-011` brand voice and AI personality page | active |
