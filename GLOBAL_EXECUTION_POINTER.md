...
| Backend | `APP-013` technician notification inbox review-ready at aa5baddc925755c5db7ea786236f6c1de7a6bac9 on PR #21: current signed-technician/tenant/assignment-scoped read-only activity; 995 backend/159 UI tests and real browser/HMAC/PostgreSQL proof pass (13 GET/13 OPTIONS). No provider sends/inbox mutations/deployment. Estimates remain retired; broad acceptance unchecked. Stop for owner review; one-time customer email capture proposed, not started. BE-008 accepted | active |
