...
| Backend | `APP-013` local customer-session credential and mailbox/prompt-bound consent model review-ready; exact backend commit in latest SESSION_HANDOFF.md. Fresh-session bootstrap, 15-minute session/5-minute prompt, explicit address confirmation and atomic response/evidence replay tested. 1305 backend/170 UI tests; 18 new session checks plus existing 19-migration/crash/eligibility/browser regressions; four clean audits. No production route/key/configuration, collection, verification, event grant binding, expiry admission, queue or sending. Security plan: APP013_CUSTOMER_SESSION_SECURITY_PLAN.md; legacy intake ownership, transport/recovery, fingerprint and retention remain gated. Coverage 50%, acceptance 0/12; 7-12 APP-013 / 20-35 pilot unequal sections, low confidence. No release authority; BE-008 accepted | active |
