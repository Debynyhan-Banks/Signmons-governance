...
| Backend | `APP-013` Customer Messaging Settings review-ready at 7d2a4eef0dee30447bee59e526d45a2f335c3299 on PR #21: four fixed SMS previews, owner/admin tenant preferences and queue/pre-send enforcement; 989 backend/145 UI tests and real browser-to-disposable-PostgreSQL proof pass. Route/controller registered in source only; no delivery activation/deployment. Old percentage estimates retired; acceptance unchecked. Stop for review; technician inbox proposed, not started. BE-008 accepted | active |
