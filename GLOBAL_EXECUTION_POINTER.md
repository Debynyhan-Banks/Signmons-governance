...
| Backend | `APP-013` lifecycle/technician Calendar mutation guards and provisional-hold UI are review-ready on PR #21; inactive CREATE execution remains unregistered; policy coordination, authorized orchestration/recovery ownership, dependencies and acceptance stay open; BE-008 accepted | active |
