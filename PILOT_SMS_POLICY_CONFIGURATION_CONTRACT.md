...
P2 inactive policy-bound capture bridge implemented in backend 6c9f660. Separate DRY_RUN-only evidence binds full registry projection, immutable version/current revision, recipient/session and suppression identity/revision with atomic audit and exact retry. Post-write current-source/time checks refuse revoked or expired publication authority. No fixture promotion, live consent relation or browser/production registration. Evidence: evidence/APP-013/policy-bound-sms-capture/README.md. Next proposed P2 section: provider-event replay identity and STOP/START retry protection. Production mode, retention/key lifecycle, protected transport, actual publication and release remain gated. Older next-bridge statements below are historical.
