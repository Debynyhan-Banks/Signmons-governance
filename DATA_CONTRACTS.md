...
## Current: P05 active — customer UI validated; connected proof remains

P05 active: existing customer-intake-journey page now supports explicit controlled presentation, customer-confirmed structured address snapshot/v2 submit, correction without auto-adoption, retained refusal/uncertainty draft, exact lost-ack retry and truthful created-not-booked receipt. No browser storage or authority from page flags. Twelve UI scenarios at 390/1440 pass using mocked HTTP outcomes, including explicit correction re-entry and reload clearing; mobile receipt visually reviewed. Full 2,294 tests (3 skipped), build/lint/architecture/audits and existing database/browser regressions passed. evidence/APP-013/p05-customer-ui.md. Items 1–3 locally implemented; ONE P05 item remains: actual connected controlled desktop/mobile browser-to-database proof. Mocked UI outcomes are not that acceptance. P05 remains active; P06 activation/managed ingress/live resources gated. Accepted packages 3/60 (5%), walkthrough 3/8 (37.5%), low-confidence 60–84 productive-day baseline unchanged. No new package, admin work or scope deviation.
