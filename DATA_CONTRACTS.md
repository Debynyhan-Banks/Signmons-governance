...
R08 owner-approved disposable credential canary completed2026-09-16 08:27–08:29EDT on the fixed isolated Neon child. SQL-created NOLOGIN role p06_password_canary_20260916a/OID172032 accepted one synthetic password assignment without elevation or memberships; exact guarded DROP succeeded and absence verified. Real runtime OID163840 remains NOLOGIN/NOINHERIT/no elevation/memberships0/limit10. Functional compatibility PASS; Console history retained the synthetic literal (not suitable for real-secret entry); server-statistics redaction INCONCLUSIVE because no pg_stat_statements extension/view/function is installed in neondb despite track=top/track_utility=on. No logging/extension/real-credential change or guard relaxation. Existing review/evidence records exact results and documentation-backed next option; no further live action authorized by this test. Support email was sent from Signmons, but a reply is not the sole route forward. R08-R12five and packages5/60,walkthrough3/8 unchanged; ETAunvalidated. No scope deviation beyond the expressly approved diagnostic action.
