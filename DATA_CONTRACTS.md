...
P04 remains active, not complete. The approved version2 submission now has a request-local reader in customer-intake-continuation.service.ts: authenticated session/request/revision and encrypted organization-bound history, current locked organization/payment/category state, P02 capability, database time and existing customer-text life-safety refusal. No positive policy cache or stored provider proof. Backend evidence/APP-013/p04-current-submission.md records 15 new tests (2,256 total passed, 3 skipped), real disposable PostgreSQL read/lock/revocation checks, existing browser regressions and required gates. This implements the documented loader, not the controlled job writer or a new package. Next in the SAME P04: atomic version2 persistence and authenticated exact committed replay, with controlled duplicate/rollback/recovery tests. P05 UI/route composition and P06 live evidence remain unchanged. APP013_P04_SOURCE_CARD.md retains the finite checklist. No new acceptance or completed timing sample; walkthrough 3/8 (37.5%) and accepted remaining-plan 2/60 unchanged. No scope deviation, live activation or external action.
