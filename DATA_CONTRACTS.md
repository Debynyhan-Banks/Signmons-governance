...
P04 remains active, not complete. Exact credential-valid controlled receipt replay now precedes verification, reconstructing the original submission binding from retained transcript and stored internal policy metadata. Changed input, missing/malformed records and expired credentials refuse; current policy revocation does not invalidate an already committed result. Disposable database proof covers identical concurrent receipts for one job, restart and lost-acknowledgment recovery with no verification factory on committed replay. Backend evidence/APP-013/p04-receipt-replay.md records 2,269 passing tests (3 skipped), database/browser regressions and required gates. Writer verification callbacks remain injected in this proof. Remaining in the SAME P04: full controlled verification-to-writer proof and v2 operator recovery for expired customer credentials, then final acceptance review. P05/P06 unchanged, no route/live activation. No new package, acceptance or timing sample; walkthrough 3/8 (37.5%), remaining-plan accepted 2/60. No scope deviation.
