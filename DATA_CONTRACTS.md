...
## Current: P04 active — approved address contract implemented

P04 is active, not complete. Owner approved the versioned structured-address submission amendment with “yes i approve” before implementation. APP013_P04_SOURCE_CARD.md records old/new contract and the finite remaining atomic-admission work. New controlled-intake-submission.ts/.spec.ts validates version2, unchanged seven-field draft plus confirmedAddress, exact display/parts agreement, explicit confirmation and no client authority fields. Legacy format unchanged; validator is not registered or yet consumed by a job writer. Backend evidence/APP-013/p04-address-binding.md records 17 new tests, 2,241 passing backend tests (3 skipped) and required local gates. Next is actual current-draft/policy loading, atomic version2 job/audit/consent persistence, safety and exact replay inside the SAME P04; P05/P06 remain unchanged. No new package or completed timing sample. P03 evidence remains review-ready; no new acceptance recorded, walkthrough 3/8 (37.5%) and accepted remaining-plan 2/60 unchanged. Approved contract amendment only; no additional scope deviation or external action.
