...
P04 remains active, not complete. The controlled writer now uses the current reader/P03 callback and shared atomic persistence, with version2 allowlisted records, SYSTEM_AI actor, STANDARD unassessed priority and customer submission audit. A same-transaction post-write P03 deadline/authority guard rolls back expiry. Backend evidence/APP-013/p04-atomic-writer.md records 7 new tests (2,263 total passed, 3 skipped) and disposable PostgreSQL persistence proof with explicitly injected verification callbacks: one job under concurrency, audit/consent/post-write failure rollback, null location and no downstream authority. This is not live or fully connected P03-to-writer acceptance. Exact committed replay/recovery is still pending: duplicate currently refuses safely. Next within the SAME P04: authenticated exact receipt, lost-response/restart and full controlled verification-to-writer proof. P05/P06 unchanged; no route/live activation. No new package, acceptance or completed timing sample; walkthrough 3/8 (37.5%), remaining-plan accepted 2/60. No scope deviation.
